# CUA_VL Roadmap Generation Prompt
...
4.  The AI generates a standard CUA_VL roadmap.
...
Based on the injected Topic information above, please generate a learning roadmap that follows the **CUA_VL methodology**.
...
#### CUA_VL Methodology Integration

Integrate the following CUA_VL elements into the roadmap:
...
- Evaluation of CUA_VL methodology effectiveness
...
**Generated by**: Claude with CUA_VL
**Roadmap Version**: 1.0
**Methodology Version**: CUA_VL 2.0
```
